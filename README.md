...
| **03. Continuous Sound & Glissando** | [Launch Demo ➔](https://dmuldrew.github.io/d3-audio/examples/03-continuous-stream/) | [`examples/03-continuous-stream/`](examples/03-continuous-stream/) | Unbroken continuous parameter mapping sonification (PMSon), microtonal frequency glides in exact Hertz, resonant filter sweeps, and 2D Theremin vector modulation. |
